...
<body>
  ...
  {{-- <div class="text-center pt-2 header-promotion white text-h-1-4-1">Free Shipping Now!</div> --}}
		...
		<img class="spc-logo" src="{{asset('assets/icon/spc-eshop-logo.png')}}" alt="spc-logo">
		
		</a>
		<!-- Sample menu definition -->
		<ul id="main-menu" class="sm sm-clean mt-lg-4">
		<li><a href="{!! route('shopping::newItemPage') !!}">New Items</a></li>
			<li><a href="{!! route('shopping::preOrderPage') !!}">Pre-orders</a></li>
...
<!-- cart -->
  ...
  <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js "></script>
	...
	$(document).ready(function(){
		...
		// default selected country HK
		$('#country_option_100').prop('selected',true);
