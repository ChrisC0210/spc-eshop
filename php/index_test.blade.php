						...
						<div class="row d-flex justify-content-between">
									...
									<div class="col-xl-12">
										<div class="col-12">
											<div class="card-body text-lg-left text-sm-center" style="background-color: rgba(255, 255, 255, 0.1);">
												<h4 class="text-m-7-7-7 spc-blue">*TEST* St. Paul’s College Souvenir</h4>
							...
							<div class=" col-xl-7 col-lg-7 col-md-12">
								<div class="col-xl-12">
									...
									<div class=" ">
										<img class="col-12"  src="{{ asset('assets/img/spc-slide-1-1.png') }}">
									</div>
								</div>
							</div>
							<!-- swi -->
						...
						<div class="row d-flex">
							...
							<div class=" col-xl-7 col-lg-7 col-md-12">
								<div class="col-xl-12">
									...
									<div class=" ">
										<img class="col-12" src="{{ asset('assets/img/spc-slide-2-2.png') }}">
									</div>
								</div>
							</div>
							<!-- swi -->
...
<div class="container">
	...
	<div class="row no-gutters mb-4 mt-4">
		<div class="col-xl-7 col-lg-6 col-md-12 card-bg">
			<img src="{{ asset('assets/img/spc-be-1.png') }}" alt="" class="img-fluid">
		</div>
	...
	<div class="row no-gutters mb-4 mt-4">
			<div class=" col-xl-7 col-lg-6 col-md-12 card-bg">
				<img src="{{asset('assets/img/spc-be-2.png')}}" alt="" class="img-fluid">
			</div>
			<div class="mt-2 col-xl-5 col-lg-5 col-md-12">
				<div class="py-5 py-lg-0">
	...
	<div class="row no-gutters mb-4 mt-4">
		<div class=" col-xl-7 col-lg-6 col-md-12 card-bg">
			<img src="{{asset('assets/img/spc-be-3.png')}}" alt="" class="img-fluid">
		</div>
		<div class="mt-2 col-xl-5 col-lg-5 col-md-12">
			<div class="py-5 py-lg-0">
...
<div class="container owl-carousel owl-theme owl-carousel-collect mb-4">
  ...
  <a href="{!! route('shopping::collectionPage', ['product_cat_id'=> $productCat->product_cat_id]) !!}">
		<div class="card">
			<img src="{{ asset($productCat->image_1) }}" class="card-img-top" alt="p1">
		</div>
